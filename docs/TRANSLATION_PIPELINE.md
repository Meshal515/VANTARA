...
| كل صفحة تنتظر أي صفحة سبقتها إلى القفل؛ صفحة القارئ خلف صفحات الترجمة المقدّمة | صف واحد بأولوية: الصفحة أمامك أولًا دائمًا، وزمن الانتظار يُسجَّل `queue` منفصلًا عن العمل |
| LaMa يُحمَّل حين تنتظره الصفحة | يُحمَّل في الخلفية أثناء انتظار Luna لأول صفحة فيها نص |
