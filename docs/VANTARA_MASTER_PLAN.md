...
| BE-P1-02 | ✅ مُتحقَّق | API يرجع `source.id` والواجهة تستخدم `source.sourceId` | ترتيب المصادر واللغة/fallback يتشوه | B6 |
...
| BE-P1-17 | ✅ مُتحقَّق | المصدر/fallback تفاصيله التقنية تتسرب إلى واجهة الفصول | UX تقني بدل "افتح واقرأ" | B6/F6 |
