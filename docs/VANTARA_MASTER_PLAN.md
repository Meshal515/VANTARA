...
**الأجهزة المستهدفة:** Samsung S23 Ultra · جهاز دحمي (يُحدَّد) · جهاز منصور اللوحي (يُحدَّد). والتصميم **لا يفترض قوة S23 Ultra**.
...
**شرط حاسم لم يُحسم:** **نظام جهاز منصور اللوحي.** إضافات Keiyoushi حزم أندرويد؛
إن كان iPad فهذا الطريق **يستبعده نهائيًّا**، بينما النموذج الحالي (خادم +
متصفح) يخدم أي جهاز. لا يُعتمد A1 قبل معرفة الجواب.
