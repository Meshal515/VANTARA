...
1. كل Agent يقرأ `VANTARA_MASTER_PLAN.md` وهذه الوثيقة و[`VANTARA_LESSONS.md`](VANTARA_LESSONS.md) قبل بدء أي Patch.
   — الأخيرة سجلّ أخطاءٍ وقعت هنا فعلًا؛ وأحدها (§8) عطلٌ نشأ من عملٍ متوازٍ
   بلا حجز، وهو بالضبط ما تمنعه هذه الوثيقة. ومن وقع في خطأ جديد يضيفه إليها.
