...
/* حدّ الطلبات لمضيف واحد (extensions-lib؛ التنفيذ في [RateLimitInterceptor]). */
...
fun OkHttpClient.Builder.rateLimitHost(
    ...
    permits: Int,
    period: Duration = 1.seconds,
): OkHttpClient.Builder = addInterceptor(RateLimitInterceptor(url.toHttpUrl().host, permits, period))
